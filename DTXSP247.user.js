// ==UserScript==
// @name          TA Script Bug-Fixes Pack v2.4.7 - (DTeCH)
...
// @downloadURL   https://cdn.rawgit.com/DTeCH-X/stuff/master/DTXSP247.user.js
// ==/UserScript==
							...
							members: {
								...
								checkRepairAllUnits: function () {
									try {
										...
										this.removeFromMainMenu("RepairAllUnits");
										return false;
									} catch (e) {
										console.log("MaelstromTools.checkRepairAllUnits: ", e);
										return false;
									}
								},
								...
								checkRepairAllBuildings: function () {
									try {
										...
										this.removeFromMainMenu("RepairAllBuildings");
										return false;
									} catch (e) {
										console.log("MaelstromTools.checkRepairAllBuildings: ", e);
										return false;
									}
								},
						...
						statics: {
							...
							getResourcesPart: function (cityEntities) {
								try {
									...
									for (var i1 = 0; i1 < objcityEntities.length; i1++) {
										var cityEntity = objcityEntities[i1];
						...
						members: {
							...
							getPrioList: function (city, arTechtypes, eModPackageSize, eModProduction, bOnlyTopBuildings, bOnlyAffordableBuildings) {
								try {
									...
									for (var i1 = 0; i1 < objbuildings.length; i1++) {
										var city_building = objbuildings[i1];
					...
					members : {
						...
						FH : function () {
							try {
								...
								var cname;
								for (cname in MT_Cache.Cities) {
									var item1 = new qx.ui.form.ListItem(cname, null, MT_Cache.Cities[cname].Object);
									this.ZC.add(item1);
									if (Addons.LocalStorage.getserver("Basescanner_LastCityID") == MT_Cache.Cities[cname].Object.get_Id()) {
										this.ZC.setSelection([item1]);
									}
								}
														...
														if (ncity.GetBuildingsConditionInPercent() != 0) {
															...
															if (this.ZE[i][5] != 0) {
																...
																try {
																	...
																	var defhp = 0;
																	for (var g1 in u) {
																		offhp += u[g1].get_Health();
																	}

																	u = defenseUnits;
																	//console.log("DefUnits",u);
																	for (var g2 in u) {
																		defhp += u[g2].get_Health();
																	}

...
// @description   MaelstromTools Dev, Basescanner, X-Ray, Coords, Combat Sim, ZWaves, Who's Online, Tunnel Info, ReplayShare, TA Fixes, & TA Base Upgrade Tool
...
// Tiberium Alliances Tweaks
        var mainTAT = function () {
            ...
            function createTA_Tweaks() {
                console.log('TA Tweaks loaded');

                if (localStorage.getItem('TA_Tweaks') == undefined || localStorage.getItem('TA_Tweaks') == 'undefined' || localStorage.getItem('TA_Tweaks') == 'null' || localStorage.getItem('TA_Tweaks') == null || localStorage.getItem('TA_Tweaks') == {} || localStorage.getItem('TA_Tweaks') == "") {
                var jsonConfDefault = '{"AlternativeErrorHandler": {"enabled": false,"openWindowOnError": false},"ShrinkableWindows": {"enabled": true},"MovableMessageComposingWindow": {"enabled": true},"ExtendedChatHistory": {"enabled": false, "length": 64},"AmbientSoundVolumeFix": {"enabled": true},"NotificationSidebarFix": {"enabled": true},"NotificationTickerFix": {"enabled": true},"ReportsLoadFix": {"enabled": true},"MaelstromToolsButtons": {"enabled": true,"fixRepairAll": true,"fixCollectPackages": true },"NotifyAboutNewFeatures": {"enabled": false},"PlayerBasePlateColoring": {"enabled": true}}';
                    localStorage.setItem('TA_Tweaks', jsonConfDefault);
                ...
                qx.Class.define('TA_Tweaks', {
                    ...
                    defer: function (statics) {
                        statics.CategoryNames[TA_Tweaks.Category.Useful] = 'Useful stuff';
                        statics.CategoryNames[TA_Tweaks.Category.Bugfix] = 'Game bugfixes';
                        statics.CategoryNames[TA_Tweaks.Category.Script] = '3rd party script tuning';
                        statics.CategoryNames[TA_Tweaks.Category.Uncategorized] = 'Uncategorized';
                        statics.CategoryNames[TA_Tweaks.Category.Self] = 'Settings';
                    },
                    construct: function () {
                        this.features = {};
                        this.configs = this.loadSettings();
                        this.settingsWindow = new TA_Tweaks.SettingsWindow(this, TA_Tweaks.CategoryNames);
                    ...
                    members: {
                        ...
                        loadSettings: function () {
                            return JSON.parse(localStorage.getItem('TA_Tweaks')) || {};
                        },
                        ...
                        saveSettings: function (settings) {
                            localStorage.setItem('TA_Tweaks', JSON.stringify(settings));
                        },

                        /**
                         * @param {TA_Tweaks.Feature.IFeature} featureConstructor
                         * @param {Object} options
                         */
                        registerFeature: function (featureConstructor, options) {
                            qx.Interface.assert(featureConstructor, TA_Tweaks.Feature.IFeature, true);
                            ...
                            var normalizedOptions = {
                                ...
                                category: options.category || TA_Tweaks.Category.Uncategorized,
                        ...
                        /**
                         * @param {TA_Tweaks.Feature.IFeature} feature
                         * @returns {Boolean}
                         */
                ...
                qx.Class.define('TA_Tweaks.SettingsWindow', {
                ...
                qx.Class.define('TA_Tweaks.NotificationButton', {
                ...
                qx.Interface.define('TA_Tweaks.Feature.IFeature', {
                    members: {
                        /**
                ...
                qx.Class.define('TA_Tweaks.Feature.AlternativeErrorHandler', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                            category: TA_Tweaks.Category.Useful,
                    ...
                    members: {
                        ...
                        onRender: function (checkbox, label, config) {
                            ...
                            container.add(this.openWindowOnErrorCheckbox = new qx.ui.form.CheckBox().set({
                                ...
                                marginLeft: TA_Tweaks.SettingsWindow.IndentStep,
                        ...
                        /**
                         * @returns {TA_Tweaks.NotificationButton}
                         */
                        getDesktopButton: function () {
                            if (this.desktopButton === null) {
                                this.desktopButton = new TA_Tweaks.NotificationButton().set({
                        ...
                        /**
                         * @returns {TA_Tweaks.Feature.AlternativeErrorHandler.ErrorWindow}
                         */
                        getWindow: function () {
                            if (this.window === null) {
                                this.window = new TA_Tweaks.Feature.AlternativeErrorHandler.ErrorWindow();
                ...
                qx.Class.define('TA_Tweaks.Feature.AlternativeErrorHandler.ErrorWindow', {
                    extend: qx.ui.window.Window,
                    construct: function () {
                        qx.ui.window.Window.call(this);
                ...
                qx.Class.define('TA_Tweaks.Feature.ShrinkableWindows', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                    ...
                    members: {
                        ...
                        enableWindowShrink: function (window) {
                            if (window.getUserData('TA_Tweaks.Shrinkable')) {
                                return;
                            }

                            window.setUserData('TA_Tweaks.Shrinkable', true);
                            window.setUserData('TA_Tweaks.AllowMinimize', window.getAllowMinimize());
                            window.setUserData('TA_Tweaks.ShowMinimize', window.getShowMinimize());

                            window.setAllowMinimize = function (value) {
                                this.setUserData('TA_Tweaks.AllowMinimize', value);
                            };
                            window.setShowMinimize = function (value) {
                                this.setUserData('TA_Tweaks.ShowMinimize', value);
                            };
                        ...
                        disableWindowShrink: function (window) {
                            ...
                            window.setAllowMinimize(window.getUserData('TA_Tweaks.AllowMinimize'));
                            window.setShowMinimize(window.getUserData('TA_Tweaks.ShowMinimize'));
                            window.setUserData('TA_Tweaks.AllowMinimize', undefined);
                            window.setUserData('TA_Tweaks.ShowMinimize', undefined);
                            window.setUserData('TA_Tweaks.Shrinkable', undefined);
                        ...
                        onBeforeWindowMinimize: function (event) {
                            ...
                            if (window.getUserData('TA_Tweaks.Dimensions') === null) {
                                window.setUserData('TA_Tweaks.Dimensions', {
                        ...
                        restoreWindowContent: function (window) {
                            var dimensions = window.getUserData('TA_Tweaks.Dimensions');
                            ...
                            if (dimensions !== null) {
                                ...
                                window.setUserData('TA_Tweaks.Dimensions', undefined);
                            }
                        }
                    }
                });

                qx.Class.define('TA_Tweaks.Feature.MovableMessageComposingWindow', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                ...
                qx.Class.define('TA_Tweaks.Feature.ExtendedChatHistory', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                ...
                qx.Class.define('TA_Tweaks.Feature.AmbientSoundVolumeFix', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                            category: TA_Tweaks.Category.Bugfix,
                ...
                qx.Class.define('TA_Tweaks.Feature.NotificationSidebarFix', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                ...
                qx.Class.define('TA_Tweaks.Feature.NotificationTickerFix', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                ...
                qx.Class.define('TA_Tweaks.Feature.ReportsLoadFix', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                ...
                qx.Class.define('TA_Tweaks.Feature.MaelstromToolsButtons', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                            category: TA_Tweaks.Category.Script,
                ...
                qx.Class.define('TA_Tweaks.Feature.NotifyAboutNewFeatures', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
                            category: TA_Tweaks.Category.Self,
                    ...
                    members: {
                        ...
                        activate: function (wasActive) {
                            ...
                            var core = TA_Tweaks.getInstance();
                        ...
                        onFeatureAdd: function (event) {
                            ...
                            if (!TA_Tweaks.getInstance().hasConfig(details.construct)) {
                        ...
                        onClickDesktopButton: function () {
                            TA_Tweaks.getInstance().openSettingsWindow();
                        },
                        ...
                        getDesktopButton: function () {
                            if (this.desktopButton === null) {
                                this.desktopButton = new TA_Tweaks.NotificationButton().set({
                                    ...
                                    icon: 'webfrontend/ui/icons/icn_show_combat_active.png',
                                    toolTipText: 'New features in TA_Tweaks'
                                });
                                this.desktopButton.getChildControl('icon').set({
                                    scale: true,
                                    width: 36,
                ...
                qx.Class.define('TA_Tweaks.Feature.PlayerBasePlateColoring', {
                    extend: qx.core.Object,
                    implement: [TA_Tweaks.Feature.IFeature],
                    defer: function (statics, members) {
                        TA_Tweaks.getInstance().registerFeature(members.constructor, {
            ...
            function waitForGameTAT() {
                try {
                    if (typeof qx !== 'undefined' && qx.core.Init.getApplication() && qx.core.Init.getApplication().initDone) {
                        createTA_Tweaks();
                        TA_Tweaks.getInstance().initialize();
                    }
                    else {
                        setTimeout(waitForGameTAT, 3000);
                    }
                }
                catch (e) {
                    console.log('TA_Tweaks: ', e.toString());
                }
            }
        ...
        var scriptTAT = document.createElement('script');
        scriptTAT.innerHTML = '(' + mainTAT.toString() + ')();';
        scriptTAT.type = 'text/javascript';
        document.getElementsByTagName('head')[0].appendChild(scriptTAT);
                ...
                function t() {
                    qx.Class.define("TACS", {
                        type: "singleton", extend: qx.core.Object, members: {
                            saveObj: {
                                section: {option: "foo"},
                                bounds: {battleResultsBoxLeft: 125, battleResultsBoxTop: 125},
                                checkbox: {
                                ...
                                audio: {playRepairSound: !0},
                                slider: {statsOpacity: 100}
                            },
                            buttons: {
                                attack: {
                                    layout: {save: null, load: null},
                                    simulate: null,
                                    unlock: null,
                                    repair: null,
                                    unlockReset: null,
                            ...
                            stats: {
                                spoils: {tiberium: null, crystal: null, credit: null, research: null},
                                health: {infantry: null, vehicle: null, aircraft: null, overall: null},
                                repair: {
                                    infantry: null,
                                    vehicle: null,
                                    aircraft: null,
                                ...
                                damage: {
                                    units: {overall: null}, structures: {
                                        construction: null, defense: null, command: null, support: null,
                                        overall: null
                                    }, overall: null
                                },
                                time: null,
                            ...
                            labels: {
                                ...
                                repairinfos: {infantry: null, vehicle: null, aircraft: null, available: null},
                                attacks: {available: null},
                                damage: {
                                    units: {overall: null},
                                    structures: {
                                        construction: null,
                            ...
                            view: {
                                playerCity: null, playerCityDefenseBonus: null, ownCity: null, ownCityId: null,
                                targetCityId: null, lastUnits: null, lastUnitList: null
                            },
                            layouts: {label: null, list: null, all: null, current: null, restore: null},
                            options: {
                            ...
                            audio: {soundRepairImpact: null, soundRepairReload: null},
                            _Application: null,
                            _MainData: null,
                            _Cities: null,
                            _VisMain: null,
                            ...
                            loadData: function () {
                                ...
                                if (null != b) {
                                    b = JSON.parse(b), a;
                                    for (var x in this.saveObj)if ("object" == typeof b[x])for (var c in this.saveObj[x])"object" != typeof b[x][c] && "undefined" == typeof b[x][c] && (console.log("Creating missing save option: " +
                                        x + "." + c), b[x][c] = this.saveObj[x][c]); else"undefined" == typeof b[x] && (console.log("Creating missing option section: " + x), b[x] = this.saveObj[x]);
                                    this.saveObj = b;
                                    this.saveData()
                                }
                            },
                            saveData: function () {
                                var b = this.saveObj || window.TACS.getInstance().saveObj, b = JSON.stringify(b);
                            ...
                            initialize: function () {
                                try {
                                    ...
                                    phe.cnc.Util.attachNetEvent(this._VisMain,
                                        "ViewModeChange", ClientLib.Vis.ViewModeChange, this, this.viewChangeHandler);
                                    ...
                                    b.add(this.buttons.simulate.back, {top: 12, left: 150});
                                    ...
                                    this.buttons.attack.repair.set({
                                        width: 45, height: 45, padding: 0, appearance: "button-text-small",
                                    ...
                                    this.loadLayouts();
                                    this.optionsWindow = (new qx.ui.window.Window(d("Options"),
                                        "FactionUI/icons/icon_forum_properties.png")).set({
                                            contentPaddingTop: 1,
                                    ...
                                    this.optionsWindow.getChildControl("icon").set({scale: !0, width: 25, height: 25});
                                    this.optionsWindow.setLayout(new qx.ui.layout.VBox);
                                    var e = localStorage.ta_sim_options_top;
                                    if (e) {
                                        var e = JSON.parse(localStorage.ta_sim_options_top), l = JSON.parse(localStorage.ta_sim_options_left);
                            ...
                            initializeStats: function (b) {
                                try {
                                    ...
                                    var a = new qx.ui.container.Composite, c = new qx.ui.layout.Grid;
                                    ...
                                    a.add(this.labels.countDown, {row: 0, column: 0});
                                    ...
                                    a.add(this.labels.damage.overall, {row: 0, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Defences:")), {row: 1, column: 0});
                                    this.labels.damage.units.overall = new qx.ui.basic.Label("100");
                                    a.add(this.labels.damage.units.overall, {row: 1, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Buildings:")), {row: 2, column: 0});
                                    this.labels.damage.structures.overall = new qx.ui.basic.Label("100");
                                    a.add(this.labels.damage.structures.overall, {row: 2, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Construction Yard:")),
                                        {row: 3, column: 0});
                                    this.labels.damage.structures.construction = new qx.ui.basic.Label("100");
                                    a.add(this.labels.damage.structures.construction, {row: 3, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Defense Facility:")), {row: 4, column: 0});
                                    this.labels.damage.structures.defense = new qx.ui.basic.Label("100");
                                    a.add(this.labels.damage.structures.defense, {row: 4, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Command Center:")), {row: 5, column: 0});
                                    ...
                                    a.add(this.labels.supportLevel, {row: 6, column: 0});
                                    this.labels.damage.structures.support = new qx.ui.basic.Label("");
                                    a.add(this.labels.damage.structures.support, {row: 6, column: 1});
                                    a = new qx.ui.container.Composite;
                                    c = new qx.ui.layout.Grid;
                                    c.setColumnAlign(1, "right", "middle");
                                    c.setColumnFlex(0, 1);
                                    ...
                                    a.add(this.labels.health.overall, {row: 0, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Infantry:")), {row: 1, column: 0});
                                    this.labels.health.infantry = new qx.ui.basic.Label("100");
                                    a.add(this.labels.health.infantry, {row: 1, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Vehicle:")), {row: 2, column: 0});
                                    this.labels.health.vehicle = new qx.ui.basic.Label("100");
                                    a.add(this.labels.health.vehicle, {row: 2, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Aircraft:")),
                                        {row: 3, column: 0});
                                    this.labels.health.aircraft = new qx.ui.basic.Label("100");
                                    a.add(this.labels.health.aircraft, {row: 3, column: 1});
                                    a = new qx.ui.container.Composite;
                                    c = new qx.ui.layout.Grid;
                                    c.setColumnAlign(1, "right", "middle");
                                    c.setColumnFlex(0, 1);
                                    ...
                                    a.setThemedBackgroundColor("#eef");
                                    this.statsPage.add(a);
                                    a.add(new qx.ui.basic.Label(d("Outcome:")), {row: 0, column: 0});
                                    this.labels.damage.outcome = new qx.ui.basic.Label(d("Unknown"));
                                    a.add(this.labels.damage.outcome, {
                                        row: 0,
                                        column: 1
                                    });
                                    a.add(new qx.ui.basic.Label(d("Battle Time:")), {row: 1, column: 0});
                                    this.labels.time = new qx.ui.basic.Label("120");
                                    a.add(this.labels.time, {row: 1, column: 1});
                                    a = new qx.ui.container.Composite;
                                    c = new qx.ui.layout.Grid;
                                    c.setColumnAlign(1, "right", "middle");
                                    c.setColumnFlex(0, 1);
                                    ...
                                    a.setThemedBackgroundColor("#eef");
                                    this.statsPage.add(a);
                                    a.add(new qx.ui.basic.Label(d("Available Repair:")), {row: 0, column: 0});
                                    this.labels.repair.available = new qx.ui.basic.Label("00:00:00");
                                    a.add(this.labels.repair.available, {row: 0, column: 1});
                                    a.add(new qx.ui.basic.Label(d("Available Attacks:")), {row: 1, column: 0});
                                    this.labels.attacks.available = new qx.ui.basic.Label("CP:- / FR:- / CFR:-");
                                    a.add(this.labels.attacks.available, {row: 1, column: 1})
                                } catch (e) {
                                    console.log(e)
                                }
                            },
                            initializeLayout: function (b) {
                                try {
                                    ...
                                    this.layouts.list.set({height: 174, selectionMode: "one"});
                                    ...
                                    this.buttonLayoutDelete.set({
                                        width: 80, appearance: "button-text-small",
                            ...
                            initializeInfo: function (b) {
                                try {
                                    ...
                                    var f = new qx.ui.container.Composite, g = new qx.ui.layout.Grid;
                                    f.setLayout(g);
                                    ...
                                    f.add(this.buttons.optionStats, {row: 0, column: 0});
                            ...
                            initializeOptions: function () {
                                try {
                                    ...
                                    var a = new qx.ui.container.Composite, c = new qx.ui.layout.Grid(5, 5);
                                    c.setColumnFlex(2, 1);
                                    a.setLayout(c);
                                    a.setThemedFont("bold");
                                    a.setThemedBackgroundColor("#eef");
                                    ...
                                    a.add(this.options.autoDisplayStats, {row: 1, column: 0, colSpan: 3});
                                    ...
                                    a.add(this.options.markSavedTargets, {row: 2, column: 0, colSpan: 3});
                                    ...
                                    a.add(this.options.dblClick2DeActivate, {row: 3, column: 0, colSpan: 3});
                                    ...
                                    a.add(this.options.showShift, {row: 4, column: 0, colSpan: 3});
                                    ...
                                    (e = localStorage.ta_sim_side) ? (e = JSON.parse(localStorage.ta_sim_side), this.options.rightSide.setValue(e)) : this.options.rightSide.setValue(!0);
                                    l.addListener("changeSelection", this.setupInterface, this);
                                    a.add(this.options.sideLabel, {row: 5, column: 0});
                                    a.add(this.options.leftSide, {row: 5, column: 1});
                                    a.add(this.options.rightSide, {row: 5, column: 2});
                                    ...
                                    a.add(this.options.locksLabel, {row: 6, column: 0});
                                    a.add(this.options.attackLock, {row: 6, column: 1});
                                    a.add(this.options.repairLock, {row: 6, column: 2});
                                    ...
                                    a.add(this.options.showStatsDuringAttack, {row: 7, column: 0, colSpan: 3});
                                    ...
                                    a.add(this.options.showStatsDuringSimulation, {row: 8, column: 0, colSpan: 3});
                                    ...
                                    a.add(this.options.statsOpacityLabel, {row: 12, column: 0, colSpan: 3});
                                    this.options.statsOpacity = new qx.ui.form.Slider;
                                    a.add(this.options.statsOpacity, {row: 13, column: 1, colSpan: 2});
                                    ...
                                    a.add(this.options.statsOpacityOutput, {row: 13, column: 0});
...
//                        this.saveObj.checkbox[b.saveLocation] = a;
                                this.saveObj.checkbox[b.saveLocation] = b.getValue();
                                this.saveData()
                            },
                            createBasePlateFunction: function (b) {
                                try {
                                    ...
                                    for (c in a)if ("function" === typeof a[c] && (e = a[c].toString(), -1 < e.indexOf("region_city_owner"))) {
                                        ...
                                        var e = e.match(c).toString(), d = e.slice(0, 6);
                                        if (b === ClientLib.Vis.Region.RegionNPCCamp) {
                                            var f = "return " + e.slice(12, 21) + ".prototype." + e.slice(23, 29) + ".toString();", g = Function("", f), e = g();
                                            c = /.I.[A-Z]{6}.prototype.[A-Z]{6}/;
                                            var k = e.match(/.I.[A-Z]{6}.prototype/).toString(), e = e.match(c).toString(), f = "return " + e + ".toString();", g = Function("", f), e = g(), h = e.match(/this.[A-Z]{6}=a/).toString(), h = "this." + h.slice(5, 11) + "=a;", n = e.match(/this.[A-Z]{6}\(\)/).toString(),
                                                n = "this." + n.slice(5, 13) + ";", m = k + ".setPlateColor = function(a){" + h + n + "};regionObject.get_BasePlate = function(){return this." + d + ";}"
                            ...
                            initToolBarListeners: function () {
                                try {
                                    var b = this._PlayArea.getLayoutParent().getBounds(), a = this._PlayArea.getLayoutParent().getBounds().width;
                                    this._PlayArea.addListener("mouseover", function () {
                                        this.toolBar.isVisible() && (this.toolBarMouse.show(),
                                            this.toolBar.setLayoutProperties({bottom: this.TOOL_BAR_LOW}), this.toolBar.setZIndex(1))
                                    }, this);
                                    ...
                                    this.toolBarMouse.addListener("mouseover", function () {
                                        ...
                                        this.toolBar.setLayoutProperties({bottom: this.TOOL_BAR_HIGH})
                                    }, this);
                                    ...
                                    this._armyBar.addListener("mouseover", function () {
                                            this.toolBarMouse.show();
                                            this.toolBar.setZIndex(1);
                                            this.toolBar.setLayoutProperties({bottom: this.TOOL_BAR_LOW})
                                        },
                                        this);
                            ...
                            setupInterface: function () {
                                try {
                                    ...
                                    var b = this._Application.getUIItem(ClientLib.Data.Missions.PATH.OVL_PLAYAREA), a = this._Application.getUIItem(ClientLib.Data.Missions.PATH.OVL_PLAYAREA).getLayoutParent().getLayoutParent().getBounds().width;
                                    ...
                                    this.repairInfo.set({visibility: !1});
                                    this.repairInfo.add(new qx.ui.basic.Image("webfrontend/ui/icons/icn_repair_off_points.png"), {
                                        row: 0,
                                        column: 1
                                    });
                                    this.labels.repairinfos.available = (new qx.ui.basic.Label("100")).set({textColor: "white"});
                                    this.repairInfo.add(this.labels.repairinfos.available, {row: 0, column: 0});
                                    this.repairInfo.add(new qx.ui.basic.Image("webfrontend/ui/icons/icon_res_repair_inf.png"), {
                                        row: 1,
                                        column: 1
                                    });
                                    this.labels.repairinfos.infantry = (new qx.ui.basic.Label("100")).set({textColor: "white"});
                                    this.repairInfo.add(this.labels.repairinfos.infantry, {row: 1, column: 0});
                                    this.repairInfo.add(new qx.ui.basic.Image("webfrontend/ui/icons/icon_res_repair_tnk.png"), {
                                        row: 2,
                                        column: 1
                                    });
                                    this.labels.repairinfos.vehicle = (new qx.ui.basic.Label("100")).set({textColor: "white"});
                                    this.repairInfo.add(this.labels.repairinfos.vehicle, {row: 2, column: 0});
                                    this.repairInfo.add(new qx.ui.basic.Image("webfrontend/ui/icons/icon_res_repair_air.png"), {
                                        row: 3,
                                        column: 1
                                    });
                                    this.labels.repairinfos.aircraft = (new qx.ui.basic.Label("100")).set({textColor: "white"});
                                    this.repairInfo.add(this.labels.repairinfos.aircraft, {row: 3, column: 0});
                                    b.add(this.repairInfo, {bottom: 130, right: 3});
                                    ...
                                    this.toolBar.set({
                                        decorator: (new qx.ui.decoration.Background).set({backgroundImage: "FactionUI/menues/victory_screen/bgr_victscr_header.png"}),
                                        visibility: !1
                                    });
                                    ...
                                    this._armyBar.getLayoutParent().getLayoutParent().add(this.toolBarMouse,
                                        {bottom: 155, left: (a - this.TOOL_BAR_WIDTH) / 2});
                                    this.toolBarMouse.hide();
                                    ...
                                    this.buttons.attack.activateAll.addListener("changeValue",
                                        function () {
                                    ...
                                    this.buttons.attack.activateInfantry.addListener("changeValue",
                                        function () {
                                    ...
                                    this.buttons.attack.activateAir.addListener("changeValue",
                                        function () {
                                    ...
                                    this.buttons.attack.flipHorizontal.addListener("click",
                                        function () {
                                    ...
                                    this.buttons.attack.options.addListener("click", this.toggleOptionsWindow,
                                        this);
                                    this.toolBar.add(this.buttons.attack.flipVertical, {top: 10, left: 10});
                                    this.toolBar.add(this.buttons.attack.flipHorizontal, {top: 10, left: 60});
                                    this.toolBar.add(this.buttons.attack.activateAll, {top: 10, left: 130});
                                    this.toolBar.add(this.buttons.attack.activateInfantry, {top: 10, left: 180});
                                    this.toolBar.add(this.buttons.attack.activateVehicles, {top: 10, left: 230});
                                    this.toolBar.add(this.buttons.attack.activateAir, {top: 10, left: 280});
                                    this.toolBar.add(this.buttons.attack.toolbarRefreshStats, {top: 10, left: 349});
                                    this.toolBar.add(this.buttons.attack.options, {top: 10, right: 10});
                                    this.toolBar.add(this.buttons.attack.repairMode, {top: 10, right: 60});
                                    this.toolBar.add(this.buttons.attack.toolbarShowStats, {top: 10, right: 110});
                                    this.toolBar.add(this.buttons.attack.toolbarRedo, {top: 10, right: 175});
                                    this.toolBar.add(this.buttons.attack.toolbarUndo, {top: 10, right: 225});
                                    this.toolBar.add(this.buttons.attack.formationReset, {top: 10, right: 275});
                                    this.userInterface && this._armyBar.remove(this.userInterface);
                                    if (this.options.rightSide.getValue())
                                        var h = 64, n = g, m = 5, q = 0, s = 30, w = 15, x = 15; else h = 90, n = f, m = 15, q = 16, s = 46, x = w = 30;
                                    ...
                                    this.userInterface.set({decorator: (new qx.ui.decoration.Background).set({backgroundImage: n})});
                                    this.options.rightSide.getValue() ? this._armyBar.add(this.userInterface, {
                                        top: 0,
                                        right: 53
                                    }) : this._armyBar.add(this.userInterface, {top: 0, left: 0});
                                    ...
                                    this.buttons.shiftFormationLeft.set({
                                        width: 30,
                                        appearance: "button-text-small", toolTipText: d("Shift units left")
                                    });
                                    ...
                                    this.buttons.shiftFormationUp.set({
                                        width: 30,
                                        appearance: "button-text-small", toolTipText: d("Shift units up")
                                    });
                                    ...
                                    if (y = y ? JSON.parse(localStorage.ta_sim_showShift) :
                                        ...
                                        top: 35,
                                        right: q
                                    }), this.userInterface.add(this.buttons.shiftFormationDown, {top: 54, right: x});
                                    this.userInterface.add(this.buttons.attack.tools, {top: 77, left: m});
                                    this.userInterface.add(this.buttons.attack.simulate, {top: 100, left: m})
                                } catch (B) {
                                    console.log(B)
                                }
                            },
                            getAttackUnits: function () {
                                try {
                                    ...
                                    if (null != a) {
                                        var c = a.get_Id(), e = b.get_CityArmyFormationsManager().GetFormationByTargetBaseId(c);
                            ...
                            optionAttackLock: function () {
                                try {
                                    localStorage.ta_sim_attackLock = JSON.stringify(this.options.attackLock.getValue()), this.options.attackLock.getValue() ? this._armyBar.add(this.buttons.attack.unlock, {
                                        top: 108,
                                        right: 9
                            ...
                            optionRepairLock: function () {
                                try {
                                    localStorage.ta_sim_repairLock = JSON.stringify(this.options.repairLock.getValue()), this.options.repairLock.getValue() ? this._armyBar.add(this.buttons.attack.repair, {
                                        top: 16,
                                        right: 9
                            ...
                            formationChangeHandler: function () {
                                try {
                                    0 == this.labels.countDown.getWidth() || this.warningIcon || (this.simulationWarning =
                                        new qx.ui.basic.Image("https://eaassets-a.akamaihd.net/cncalliancesgame/cdn/data/d75cf9c68c248256dfb416d8b7a86037.png"), this.simulationWarning.set({toolTipText: d("Simulation will be based on most recently refreshed stats!")}), this.options.rightSide.getValue() ? this._armyBar.add(this.simulationWarning, {
                                        top: 122,
                                        right: 67
                            ...
                            setLabelColor: function (b, a, c) {
                                var e = ["green", "blue", "black", "red"], d = e[0];
                                0 <= c && (a = 100 - a);
                            ...
                            updateStatsWindow: function () {
                                var b = this, a = "", c = 0;
                                0 === this.stats.damage.structures.construction ?
                                    (a = d("Total Victory"), c = 0) : 100 > this.stats.damage.structures.overall ? (a = d("Victory"), c = 1) : (a = d("Total Defeat"), c = 3);
                                this.labels.damage.outcome.setValue(a);
                                this.labels.damage.outcome.setTextColor(["black", "blue", "green", "red"][c]);
                                ...
                                this.updateLabel100(this.labels.damage.structures.construction,
                                    this.stats.damage.structures.construction, -1);
                                ...
                                setTimeout(function () {
                                        b.stats.time = b._VisMain.get_Battleground().get_BattleDuration() / 1E3;
                            ...
                            calculateDefenseBonus: function (b, a) {
                                try {
                                    this.view.playerCityDefenseBonus = Math.round(ClientLib.Base.PointOfInterestTypes.GetTotalBonusByType(ClientLib.Base.EPOIType.DefenseBonus,
                                        a.rpois[6].r, a.rpois[6].s))
                                } catch (c) {
                                    console.log(c)
                                }
                            },
                                ...
                                try {
                                    switch (this.hideAll(), a) {
                                        ...
                                        case ClientLib.Vis.Mode.CombatSetup:
                                            this.curPAVM = qx.core.Init.getApplication().getPlayArea().getViewMode(), this.onCityLoadComplete()
                                    }
                                } catch (c) {
                                    console.log(c)
                                }
                            ...
                            resetDisableButtons: function () {
                                try {
                                    ...
                                    this.buttons.attack.activateInfantry.setValue(!1), this.buttons.attack.activateVehicles.getValue(!0) && this.buttons.attack.activateVehicles.setValue(!1), this.buttons.attack.activateAir.getValue(!0) && this.buttons.attack.activateAir.setValue(!1)
                                } catch (b) {
                                    console.log(b)
                                }
                            },
                                            ...
                                            if (null != a) {
                                                ...
                                                if (null != this.targetCityId && this.targetCityId !== a.get_Id()) {
                                                    ...
                                                    if (this.view.playerCity) {
                                                        ...
                                                        ClientLib.Net.CommunicationManager.GetInstance().SendSimpleCommand("GetPublicAllianceInfo", {id: d}, phe.cnc.Util.createEventDelegate(ClientLib.Net.CommandResult,
                                                            this, this.calculateDefenseBonus), null)
                                                    }
                                                }
                            ...
                            returnSetup: function () {
                                try {
                                    ...
                                    this._Application.getPlayArea().setView(ClientLib.Data.PlayerAreaViewMode.pavmCombatSetupDefense, localStorage.ta_sim_last_city, 0, 0), console.log(b)
                                }
                            },
                            checkAttackRange: function () {
                                try {
                                    var b =
                                        this._MainData.get_Cities(), a = b.get_CurrentCity();
                                    if (null != a) {
                            ...
                            startSimulation: function () {
                                try {
                                    if (1E4 < Date.now() - this.lastSimulation) {
                                        var b = this._MainData.get_Cities().get_CurrentOwnCity();
                                    ...
                                    } else this.enterSimulationView(), this._VisMain.get_Battleground().RestartReplay(),
                                        this._VisMain.get_Battleground().set_ReplaySpeed(1)
                                } catch (a) {
                                    console.log(a)
                                }
                            ...
                            onSimulateBattleFinishedEvent: function (b) {
                                ...
                                try {
                                    ...
                                    var a = 0, c = 0, e = 0, d = 0, f = 0, g = 0, k = 0, h = 0, n = 0, m = 0, q = 0, s = 0, w = 0, x = 0, y = 0, B = 0, t = 0;
                                    ...
                                    10 == this.count && (this.counter = setInterval(this.countDownToNextSimulation, 1E3));
                                    for (var u = 0; u < b.length; u++) {
                                        var D = b[u].Value, z = D.t, v = ClientLib.Res.ResMain.GetInstance().GetUnit_Obj(z), C = v.pt, F = v.mt, A = D.l, E = D.sh, r = D.h, p = ClientLib.API.Util.GetUnitMaxHealthByLevel(A, v, !1);
                                        switch (C) {
                                            case ClientLib.Base.EPlacementType.Defense:
                                                if (this.view.playerCity)
                                                    var H = this.view.playerCityDefenseBonus, I = ClientLib.Base.Util.GetNerfAndBoostModifier(A, H), p = Math.floor(p * I / 100 * 16) / 16;
                                                k += p;
                                                h += r;
                                                e += p;
                                                d += r;
                                            ...
                                            case ClientLib.Base.EPlacementType.Offense:
                                                ...
                                                switch (F) {
                                                    ...
                                                    case ClientLib.Base.EUnitMovementType.Air2:
                                                        w +=
                                                            p, q += r, B += this.getRepairCost(E, r, p, A, z)
                                                }
                                                break;
                                            case ClientLib.Base.EPlacementType.Structure:
                                                this.view.playerCity && (H = this.view.playerCityDefenseBonus, I = ClientLib.Base.Util.GetNerfAndBoostModifier(A, H), p = Math.floor(p * I / 100 * 16) / 16), f += p, g += r, e += p, d += r
                                        }
                                        if (200 <= z && 205 >= z)this.stats.supportLevel = A, this.stats.damage.structures.support = r / 16 / p * 100; else switch (z) {
                                            case 131:
                                            case 158:
                                            case 195:
                            ...
                            saveUndoState: function () {
                                var b = this.getFormation(), a = this.getTimestamp(), c = this.badClone(this.stats);
                                this.undoCache[0] = {f: b, t: a, s: c};
                            ...
                            updateLayoutsList: function () {
                                try {
                                    if (this.layouts.list.removeAll(),
                                            this.loadCityLayouts(), this.layouts.current)for (var b in this.layouts.current) {
                                        var a = this.layouts.current[b], c = new qx.ui.form.ListItem(a.label, null, a.id);
                            ...
                            saveCityLayout: function () {
                                var b = [], a, c;
                                try {
                                    b = this.getFormation(), a = (new Date).getTime().toString(), c = null !== this.stats.damage.structures.construction ? this.layouts.label.getValue() + " (" + this.stats.damage.structures.construction.toFixed(0).toString() +
                                    ":" + this.stats.damage.structures.defense.toFixed(0).toString() + ":" + this.stats.damage.units.overall.toFixed(0).toString() + ")" : this.layouts.label.getValue() + " (??:??:??)", this.layouts.current[a] = {
                                        id: a,
                                        label: c,
                                        layout: b
                                    }, this.saveLayouts(), this.updateLayoutsList(), this.updateSaveMarkers(), this.layouts.label.setValue("")
                                } catch (e) {
                                    console.log(e)
                                }
                                return a
                            ...
                            loadCityLayouts: function () {
                                try {
                                    if (null != this._MainData.get_Cities().get_CurrentCity()) {
                                        var b = this._MainData.get_Cities().get_CurrentCity().get_Id(), a =
                            ...
                            getFormation: function () {
                                ...
                                try {
                                    for (var a = 0; a < this.view.lastUnitList.length; a++) {
                                        var c = this.view.lastUnitList[a], e = {};
                                        e.x = c.get_CoordX();
                                        e.y = c.get_CoordY();
                                        e.id = c.get_Id();
                                        e.e = c.get_Enabled();
                            ...
                            shiftFormation: function (b) {
                                ...
                                for (b = 0; b < this.view.lastUnitList.length; b++) {
                                    var d = this.view.lastUnitList[b], f = {}, g = d.get_CoordX() + e;
                                    switch (g) {
                                        case 9:
                                            g = 0;
                                            break;
                            ...
                            flipFormation: function (b) {
                                ...
                                try {
                                    for (var c = 0; c < this.view.lastUnitList.length; c++) {
                                        var e = this.view.lastUnitList[c], d = {}, f = e.get_CoordX(), g = e.get_CoordY();
                            ...
                            activateUnits: function (b, a) {
                                ...
                                try {
                                    for (var e = 0; e < this.view.lastUnitList.length; e++) {
                                        var d = this.view.lastUnitList[e], f = {};
                                        switch (b) {
                                            case "air":
                                ...
                                for (var c = b._VisMain.get_CombatSetup(), e = c.get_ZoomFactor(), d = Math.round(c.get_MinXPosition() * e * -1) + 10, c = Math.round(c.get_GridWidth() * e), e = 0; e < b.view.lastUnitList.length; e++) {
                                    ...
                                    if (1 > f.get_HitpointsPercent()) {
                                        ...
                                        b.repairButtons[e].set({
                                            decorator: (new qx.ui.decoration.Background).set({backgroundColor: "transparent"}),
                                            width: c,
                                            height: 38,
                                            show: "icon",
                                            center: !1,
                            ...
                            toggleRepairMode: function () {
                                try {
                                    ...
                                    (this.audio.soundRepairImpact = new Audio(window.soundRepairImpact.d), this.audio.soundRepairReload = new Audio(window.soundRepairReload.d), this.audio.soundRepairImpact.volume = this.getAudioSettings().ui / 100, this.audio.soundRepairReload.volume = this.getAudioSettings().ui / 100), this._armyBar.getLayoutParent().toggleEnabled(), this._armyBar.setEnabled(!0), this.userInterface.toggleEnabled(), this.battleResultsBox.toggleEnabled(), this.buttons.attack.repairMode.getValue() ? (this.redrawRepairButtons(), this._armyBar.addListener("resize",
                                        this.setResizeTimer, this), this.repairInfo.show(), this.updateRepairTimeInfobox(), this.repairModeTimer = setInterval(this.updateRepairTimeInfobox, 1E3)) : (this.removeAllRepairButtons(), this._armyBar.removeListener("resize", this.setResizeTimer, this), this.repairInfo.hide(), clearInterval(this.repairModeTimer))
                                } catch (b) {
                                    console.log(b)
                                }
                            },
                            updateRepairTimeInfobox: function () {
                                try {
                                    var b = window.TACS.getInstance(), a = b._MainData.get_Cities().get_CurrentOwnCity(), c = a.GetResourceCount(ClientLib.Base.EResourceType.RepairChargeInf),
                                        e = a.GetResourceCount(ClientLib.Base.EResourceType.RepairChargeVeh), d = a.GetResourceCount(ClientLib.Base.EResourceType.RepairChargeAir);
                            ...
                            updateSaveMarkers: function () {
                                try {
                                    if (this.options.markSavedTargets.getValue()) {
                                        var b = this._MainData.get_Cities().get_CurrentOwnCity(), a = b.get_Id(), c = b.get_X(), d = b.get_Y(), l = this._VisMain.get_Region(),
                ...
                function u() {
                    try {
                        if ("undefined" !== typeof qx) {
                            var b = qx.core.Init.getApplication(), a = qx.core.Init.getApplication().getMenuBar(),
                                c = ClientLib.Vis.VisMain.GetInstance(), d = ClientLib.Data.MainData.GetInstance();
                            if (b && a && c && d && "undefined" !== typeof PerforceChangelist)if (10 < F || "undefined" !== typeof CCTAWrapper_IsInstalled) {
                                ...
                                if (392583 <= PerforceChangelist) {
                                    var l = ClientLib.Data.Cities.prototype.get_CurrentCity.toString(), f;
                                    ...
                                    var g = ClientLib.Data.Cities.prototype.get_CurrentOwnCity.toString(), k;
                                    ...
                                    var h = ClientLib.API.Util.GetUnitRepairCosts.toString(), h = h.replace(l, g), n = h.substring(h.indexOf("{") + 1, h.lastIndexOf("}")), m = Function("a,b,c", n);
                                    ClientLib.API.Util.GetUnitRepairCosts = m;
                                }
                            ...
                            } else F++, window.setTimeout(u, 1E3); else window.setTimeout(u, 1E3)
                        } else window.setTimeout(u, 1E3)
                    } catch (s) {
                ...
                var v = null, C =
                    "tr_TR de_DE pt_PT it_IT nl_NL hu_HU fr_FR fi_FI".split(" "), G = {
                ...
                /commandandconquer\.com/i.test(document.domain) && window.setTimeout(u, 1E3)
            }.toString() + ")();";
...
// Tiberium Alliances Zone Waves (DTeCH)
            ...
            qx.Class.define("Aa", {
                ...
                members: {
                    ...
                    initialize: function () {
                        ...
                        e.add((new qx.ui.basic.Atom("Zone Waves - (UBR Tools)", "data:image/gif;base64,")).set({
                            font: "font_size_14",
                            textColor: "text-region-value"
                        }));
                        e.add(c);
    ...
    q.innerHTML = "(" + p.toString() + ")();";
    q.type = "text/javascript";
    document.getElementsByTagName("head")[0].appendChild(q);

// C&C:Tiberium Alliances Coords Button - DTeCH
        /*  Dissabled, because EA added a coords button into the game now
...
// Tiberium Alliances Tunnel Info - DTeCH
        ...
        /*
// Tiberium Alliances - New Resource Trade Window - DTeCH *only script that was error free :)*
        var NewTradeOverlay_main = function () {
            function CreateNewTradeOverlay() {
                console.log('New Resource Trade Window loaded');
                ...
                qx.Class.define("webfrontend.gui.trade.TradeOverlay", {
                    ...
                    members: {
                        ...
                        activate: function () {
                            console.log("TradeWindow activate");
                            if (!this.activated) {
                        ...
                        deactivate: function () {
                            console.log("TradeWindow deactivate");
                            if (this.activated) {
                        ...
                        tradeWindow: function () {
                            console.log("TradeWindow tradeWindow");
                        ...
                        TableRowFilter: function () {
                            console.log("TradeWindow TableRowFilter");
                            var tableArray = [];
                        ...
                        SelectAllRows: function () {
                            console.log("TradeWindow SelectAllRows");
                        ...
                        AmountSort: function (bI, bJ) {
                            console.log("TradeWindow AmountSort");
                            if (bI[4] < bJ[4])
                                return -1;
                            if (bI[4] > bJ[4])
                                return 1;
                        ...
                        UpdateSelectedRows: function (rowData) {
                            console.log("TradeWindow UpdateSelectedRows");
                            this.transferWindowTableSelectedRows = [];
                        ...
                        TradeWindowTableCellClick: function (e) {
                            console.log("TradeWindow TradeWindowTableCellClick");
                        ...
                        ChangeResourceType: function (e) {
                            console.log("TradeWindow ChangeResourceType");
                        ...
                        ResourceAmountChanged: function () {
                            console.log("TradeWindow ResourceAmountChanged");
                            this.modifier = 1;
                            this.SetCostLabel();
                        },
                        CalculateTradeCost: function () {
                            console.log("TradeWindow CalculateTradeCost");
                        ...
                        ModifyResourceAmount: function (modifier) {
                            console.log("TradeWindow ModifyResourceAmount");
                            this.totalResourceAmount = 0;
                        ...
                        SetCostLabel: function () {
                            console.log("TradeWindow SetCostLabel");
                        ...
                        TenPercent: function () {
                            console.log("TradeWindow TenPercent");
                            this.modifier = 0.1;
                        ...
                        TwentyFivePercent: function () {
                            console.log("TradeWindow TwentyFivePercent");
                            this.modifier = 0.25;
                        ...
                        FiftyPercent: function () {
                            console.log("TradeWindow FiftyPercent");
                            this.modifier = 0.5;
                        ...
                        SeventyFivePercent: function () {
                            console.log("TradeWindow SeventyFivePercent");
                            this.modifier = 0.75;
                        ...
                        OneHundredPercent: function () {
                            console.log("TradeWindow OneHundredPercent");
                            this.modifier = 1;
                        ...
                        TradeWithBases: function () {
                            console.log("TradeWindow TradeWithBases");
                        ...
                        TradeResult: function (ce, result) {
                            console.log("TradeWindow TradeResult");
                        ...
                        UpdateTradeTableData: function () {
                            console.log("TradeWindow UpdateTradeTableData");
                        ...
                        MaintainTradeWindow: function () {
                            console.log("TradeWindow MaintainTradeWindow");
                        ...
                        _onTick: function () {
                            console.log("TradeWindow _onTick");
                            var currentCity = ClientLib.Data.MainData.GetInstance().get_Cities().get_CurrentOwnCity();
            ...
            function NewTradeOverlay_checkIfLoaded() {
                console.log("TradeWindow NewTradeOverlay_checkIfLoaded");
                try {

	...
	var mainTAT = function() {
		...
		function createTATweaks() {
			console.log('TA Tweaks loaded');
                console.log('TA Tweaks loaded');
                if (localStorage.getItem('TATweaks2') == undefined || localStorage.getItem('TATweaks2') == 'undefined' || localStorage.getItem('TATweaks2') == 'null' || localStorage.getItem('TATweaks2') == null || localStorage.getItem('TATweaks2') == {} || localStorage.getItem('TATweaks2') == "") {
                var jsonConfDefault = '{"AlternativeErrorHandler":{"enabled":true,"openWindowOnError":false},"ShrinkableWindows":{"enabled":true},"MovableMessageComposingWindow":{"enabled":true},"ExtendedChatHistory":{"enabled":false,"length":64},"AmbientSoundVolumeFix":{"enabled":true},"NotificationTickerFix":{"enabled":true},"ReportsLoadFix":{"enabled":true},"MaelstromToolsButtons":{"enabled":true,"fixRepairAll":true,"fixCollectPackages":true},"NotifyAboutNewFeatures":{"enabled":false},"PlayerBasePlateColoring":{"enabled":true}}';
                    localStorage.setItem('TATweaks2', jsonConfDefault);
			...
			qx.Class.define('TATweaks2', {
				...
				defer: function(statics) {
					statics.CategoryNames[TATweaks2.Category.Useful] = 'Useful stuff';
					statics.CategoryNames[TATweaks2.Category.Bugfix] = 'Game bugfixes';
					statics.CategoryNames[TATweaks2.Category.Script] = '3rd party script tuning';
					statics.CategoryNames[TATweaks2.Category.Uncategorized] = 'Uncategorized';
					statics.CategoryNames[TATweaks2.Category.Self] = 'Settings';
				},
				construct: function() {
					this.features = {};
					this.configs = this.loadSettings();
					this.settingsWindow = new TATweaks2.SettingsWindow(this, TATweaks2.CategoryNames);
				...
				members: {
					...
					initialize: function() {
						...
						if (!this.hasSavedSettings()) {
							webfrontend.gui.MessageBox.messageBox({
								...
								text: 'Looks like this is your first time running TA Tweaks in this server. Open settings now?<br/><br/>'
					...
					hasSavedSettings: function() {
						return localStorage.getItem('TATweaks2') !== null;
					},
					...
					loadSettings: function() {
						return JSON.parse(localStorage.getItem('TATweaks2')) || {};
					},
					...
					saveSettings: function(settings) {
						localStorage.setItem('TATweaks2', JSON.stringify(settings));
					},

					/**
					 * @param {TATweaks2.Feature.IFeature} featureConstructor
					 * @param {Object} options
					 */
					registerFeature: function(featureConstructor, options) {
						qx.Interface.assert(featureConstructor, TATweaks2.Feature.IFeature, true);
						...
						var normalizedOptions = {
							...
							category: options.category || TATweaks2.Category.Uncategorized,
					...
					/**
					 * @param {TATweaks2.Feature.IFeature} feature
					 * @returns {Boolean}
					 */
			...
			qx.Class.define('TATweaks2.SettingsWindow', {
			...
			qx.Class.define('TATweaks2.NotificationButton', {
			...
			qx.Interface.define('TATweaks2.Feature.IFeature', {
				members: {
					/**
			...
			qx.Class.define('TATweaks2.Feature.AlternativeErrorHandler', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
						category: TATweaks2.Category.Useful,
				...
				members: {
					...
					onRender: function(checkbox, label, config) {
						...
						container.add(this.openWindowOnErrorCheckbox = new qx.ui.form.CheckBox().set({
							...
							marginLeft: TATweaks2.SettingsWindow.IndentStep,
					...
					/**
					 * @returns {TATweaks2.NotificationButton}
					 */
					getDesktopButton: function() {
						if (this.desktopButton === null) {
							this.desktopButton = new TATweaks2.NotificationButton().set({
					...
					/**
					 * @returns {TATweaks2.Feature.AlternativeErrorHandler.ErrorWindow}
					 */
					getWindow: function() {
						if (this.window === null) {
							this.window = new TATweaks2.Feature.AlternativeErrorHandler.ErrorWindow();
			...
			qx.Class.define('TATweaks2.Feature.AlternativeErrorHandler.ErrorWindow', {
				extend: qx.ui.window.Window,
				construct: function() {
					qx.ui.window.Window.call(this);
			...
			qx.Class.define('TATweaks2.Feature.ShrinkableWindows', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
				...
				members: {
					...
					enableWindowShrink: function(window) {
						if (window.getUserData('TATweaks2.Shrinkable')) {
							return;
						}

						window.setUserData('TATweaks2.Shrinkable', true);
						window.setUserData('TATweaks2.AllowMinimize', window.getAllowMinimize());
						window.setUserData('TATweaks2.ShowMinimize', window.getShowMinimize());

						window.setAllowMinimize = function(value) {
							this.setUserData('TATweaks2.AllowMinimize', value);
						};
						window.setShowMinimize = function(value) {
							this.setUserData('TATweaks2.ShowMinimize', value);
						};
					...
					disableWindowShrink: function(window) {
						...
						window.setAllowMinimize(window.getUserData('TATweaks2.AllowMinimize'));
						window.setShowMinimize(window.getUserData('TATweaks2.ShowMinimize'));
						window.setUserData('TATweaks2.AllowMinimize', undefined);
						window.setUserData('TATweaks2.ShowMinimize', undefined);
						window.setUserData('TATweaks2.Shrinkable', undefined);
					...
					onBeforeWindowMinimize: function(event) {
						...
						if (window.getUserData('TATweaks2.Dimensions') === null) {
							window.setUserData('TATweaks2.Dimensions', {
					...
					restoreWindowContent: function(window) {
						var dimensions = window.getUserData('TATweaks2.Dimensions');
						...
						if (dimensions !== null) {
							...
							window.setUserData('TATweaks2.Dimensions', undefined);
						}
					}
				}
			});

			qx.Class.define('TATweaks2.Feature.MovableMessageComposingWindow', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
			...
			qx.Class.define('TATweaks2.Feature.ExtendedChatHistory', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
			...
			qx.Class.define('TATweaks2.Feature.AmbientSoundVolumeFix', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
						category: TATweaks2.Category.Bugfix,
			...
			qx.Class.define('TATweaks2.Feature.NotificationSidebarFix', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
			...
			qx.Class.define('TATweaks2.Feature.NotificationTickerFix', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
			...
			qx.Class.define('TATweaks2.Feature.ReportsLoadFix', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
			...
			qx.Class.define('TATweaks2.Feature.MaelstromToolsButtons', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
						category: TATweaks2.Category.Script,
			...
			qx.Class.define('TATweaks2.Feature.NotifyAboutNewFeatures', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
						category: TATweaks2.Category.Self,
				...
				members: {
					...
					activate: function(wasActive) {
						...
						var core = TATweaks2.getInstance();
					...
					onFeatureAdd: function(event) {
						...
						if (!TATweaks2.getInstance().hasConfig(details.construct)) {
					...
					onClickDesktopButton: function() {
						TATweaks2.getInstance().openSettingsWindow();
					},
			...
			qx.Class.define('TATweaks2.Feature.PlayerBasePlateColoring', {
				extend: qx.core.Object,
				implement: [TATweaks2.Feature.IFeature],
				defer: function(statics, members) {
					TATweaks2.getInstance().registerFeature(members.constructor, {
		...
		function waitForGameTAT() {
			try {
				if (typeof qx !== 'undefined' && qx.core.Init.getApplication() && qx.core.Init.getApplication().initDone) {
					createTATweaks();
					TATweaks2.getInstance().initialize();
				}
				else {
				...
				console.log('TATweaks2: ', e.toString());
			}
		}

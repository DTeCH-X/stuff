...
// @description   MaelstromTools Dev, Basescanner, X-Ray, Coords, Combat Sim, ZWaves, Who's Online, Tunnel Info, Chat Colorizer, ReplayShare, TA Fixes, & TA Base Upgrade Tool
...
// @downloadURL   https://cdn.rawgit.com/DTeCH-X/stuff/master/DTXSP245.user.js
// ==/UserScript==
                            ...
                            members: {
                                ...
                                runAutoCollectTimer: function () {
                                    try {
                                        ...
                                        if (!CCTAWrapperIsInstalled()) return; // run timer only when wrapper is running
                    ...
                    qx.Class.define("MaelstromTools.Util", {
                        ...
                        statics: {
                            ArrayUnique: function (array) {
                                ...
                                var l = array.length;
                                var r = [];
                                for (var i1 = 0; i1 < l; i1++) o[array[i1]] = array[i1];
                                for (var i2 in o) r.push(o[i2]);
                                return r;
                            },
                            ...
                            getResourcesPart: function (cityEntities) {
                                try {
                                    ...
                                    for (var i2 = 0; i2 < objcityEntities.length; i2++) {
                                        var cityEntity = objcityEntities[i2];
...
//                                    var myRepair = repairData.OGALSP(0, viewMode);
//                                    var myRepair = repairData.CanRepair(0, viewMode);
//                                    repairData.get_CachedFullRepairAllCost(viewMode);
//                                    repairData.get_CachedFullRepairAllCost();
//                                    return ((myRepair != null) && (!ncity.get_IsLocked() || (viewMode != ClientLib.Vis.Mode.ArmySetup)));
                                    return ((!ncity.get_IsLocked() || (viewMode != ClientLib.Vis.Mode.ArmySetup)));
                    ...
                    qx.Class.define("MaelstromTools.LocalStorage", {
                        ...
                        statics: {
                            ...
                            set: function (key, value) {
                                try {
                                    if (MaelstromTools.LocalStorage.isSupported()) {
                                        localStorage["CCTA_MaelstromTools_Dev_" + key] = JSON.stringify(value);
                                    }
                                } catch (e) {
                            ...
                            get: function (key, defaultValueIfNotSet) {
                                try {
                                    if (MaelstromTools.LocalStorage.isSupported()) {
                                        if (localStorage["CCTA_MaelstromTools_Dev_" + key] != null && localStorage["CCTA_MaelstromTools_Dev_" + key] != 'undefined') {
                                            return JSON.parse(localStorage["CCTA_MaelstromTools_Dev_" + key]);
                                        }
                                    }
                                } catch (e) {
                            ...
                            clearAll: function () {
                                try {
                                    ...
                                    for (var key in localStorage) {
                                        if (key.indexOf("CCTA_MaelstromTools_Dev_") == 0) {
                        ...
                        members: {
                            ...
                            TabChanged: function (e) {
                                try {
                                    ...
                                    console.log("HuffyTools.UpgradePriority.TabChanged: ", ee);
                                }
                            },
                            ...
                            upgradeBuilding: function (e, eResourceType) {
                                ...
                                try {
                                    ...
                                    console.log("HuffyTools.UpgradePriority.upgradeBuilding: ", ef);
                                }
                            },
                        ...
                        members: {
                            ...
                            getPrioList: function (city, arTechtypes, eModPackageSize, eModProduction, bOnlyTopBuildings, bOnlyAffordableBuildings) {
                                try {
                                    ...
                                    for (var cityName in this.Cache) {
                                        var cityCache = this.Cache[cityName];
                                        var i1 = cityCache[MaelstromTools.Statics.Tiberium];
                                    ...
                                    if (PerforceChangelist >= 376877) { //new
                                        ...
                                        for (var i2 = 0; i2 < buildings.length; i2++) objbuildings.push(buildings[i2]);
                                    }


                                    for (var i3 = 0; i3 < objbuildings.length; i3++) {
                                        var city_building = objbuildings[i3];
